...
if (isset($_POST['addStaff'])) {
  ...
  if (empty($_POST["staff_number"]) || empty($_POST["staff_name"]) || empty($_POST['staff_email']) || empty($_POST['staff_password'])) {
    ...
    //bind paramaters
    $rc = $postStmt->bind_param('sssss', $staff_number, $staff_name, $staff_email, $staff_password, $staff_dept);
    $postStmt->execute();
          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              <form method="POST">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="addStaff" value="Add Staff" class="btn btn-success" value="" style="padding: 20px; margin-left: 20px;">
                  </div>
                </div>
              </form>
            </div>
