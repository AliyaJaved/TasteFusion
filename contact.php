 ...
 <div class="container">
   ...
   <div class="collapse navbar-collapse" id="ftco-nav">
     ...
     <li class="nav-item"><a href="home.php" class="nav-link">Home</a></li>
          ...
          <li class="nav-item"><a href="index1.php" class="nav-link">Logout</a></li>   </ul>
  </div>
</div>
</nav>
<!-- END nav -->
  ...
  <div class="container">
    <div class="row d-flex contact-info">
      ...
      <div class="col-md-3 d-flex">
       <div class="dbox">
         <p><span>Address:</span> 104 Sindhubhavan Road 1st Floor, Shilp 3, Near TradeBulls, Above Bajrang Supermarket, Bodakdev</p>
       </div>
     </div>
     <div class="col-md-3 d-flex">
       <div class="dbox">
     ...
     <div class="col-md-3 d-flex">
       <div class="dbox">
         <p><span>Email:</span> <a href="mailto:info@yoursite.com">tastefusion@gmail.com.com</a></p>
       </div>
     </div>
     <div class="col-md-3 d-flex">
       <div class="dbox">
         <p><span>Website</span> <a href="#">tastefusion.com</a></p>
       </div>
     </div>
   </div>
 </div>
